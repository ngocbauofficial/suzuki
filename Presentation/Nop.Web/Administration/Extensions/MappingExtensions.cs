...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static EstimateModel ToModel(this Estimate entity)
        {
            return entity.MapTo<Estimate, EstimateModel>();
        }

        public static Estimate ToEntity(this EstimateModel model)
        {
            return model.MapTo<EstimateModel, Estimate>();
        }

        public static Estimate ToEntity(this EstimateModel model, Estimate destination)
        {
            return model.MapTo(destination);
        }

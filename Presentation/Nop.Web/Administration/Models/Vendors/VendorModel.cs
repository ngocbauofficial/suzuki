...
namespace Nop.Admin.Models.Vendors
{
    ...
    public partial class VendorModel : BaseNopEntityModel, ILocalizedModel<VendorLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Admin.Vendors.Fields.StateId")]

        public int StateId { get; set; }

        [NopResourceDisplayName("Admin.Vendors.Fields.Address")]
        [AllowHtml]
        public string Address { get; set; }
        [NopResourceDisplayName("Admin.Vendors.Fields.GoogleMap")]
        [AllowHtml]

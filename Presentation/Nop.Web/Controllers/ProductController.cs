...
using Nop.Web.Models.CostEstimates;
    ...
    public partial class ProductController : BasePublicController
    {
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            var cachedPictures = _cacheManager.Get(productPicturesCacheKey, () =>
            {
                ...
                //all pictures
                var Ngoaithat1 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat1, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat1, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };
                var Ngoaithat2 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat2, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat2, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };


                var Ngoaithat3 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat3, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat3, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };


                var Ngoaithat4 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat4, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat4, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };


                var Ngoaithat5 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat5, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.Ngoaithat5, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var NoiThat1 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.NoiThat1, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.NoiThat1, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var NoiThat2 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.NoiThat2, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.NoiThat2, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var NoiThat3 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.NoiThat3, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.NoiThat3, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var NoiThat4 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.NoiThat4, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.NoiThat4, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var NoiThat5 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.NoiThat5, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.NoiThat5, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var NoiThat6 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.NoiThat6, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.NoiThat6, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var PhuKien1 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.PhuKien1, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.PhuKien1, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };
                var PhuKien2 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.PhuKien2, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.PhuKien2, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };


                var PhuKien3 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.PhuKien3, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.PhuKien3, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var PhuKien4 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.PhuKien4, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.PhuKien4, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };

                var PhuKien5 = new PictureModel
                {
                    ImageUrl = _pictureService.GetPictureUrl(product.PhuKien5, defaultPictureSize, !isAssociatedProduct),
                    FullSizeImageUrl = _pictureService.GetPictureUrl(product.PhuKien5, 0, !isAssociatedProduct),
                    Title = string.Format(_localizationService.GetResource("Media.Product.ImageLinkTitleFormat.Details"), model.Name),
                    AlternateText = string.Format(_localizationService.GetResource("Media.Product.ImageAlternateTextFormat.Details"), model.Name),
                };
                ...
                return new { DefaultPictureModel = defaultPictureModel, PictureModels = pictureModels , Ngoaithat1 = Ngoaithat1 , Ngoaithat2 = Ngoaithat2, Ngoaithat3 = Ngoaithat3, Ngoaithat4 = Ngoaithat4, Ngoaithat5 = Ngoaithat5,
                    NoiThat1 = NoiThat1,
                    NoiThat2 = NoiThat2,
                    NoiThat3 = NoiThat3,
                    NoiThat4 = NoiThat4,
            ...
            model.Ngoaithat1 = cachedPictures.Ngoaithat1;
            model.Ngoaithat2 = cachedPictures.Ngoaithat2;
            model.Ngoaithat3 = cachedPictures.Ngoaithat3;
            model.Ngoaithat4 = cachedPictures.Ngoaithat4;
            model.Ngoaithat5 = cachedPictures.Ngoaithat5;
            model.NoiThat1 = cachedPictures.NoiThat1;
            model.NoiThat2 = cachedPictures.NoiThat2;
            model.NoiThat3 = cachedPictures.NoiThat3;
            model.NoiThat4 = cachedPictures.NoiThat4;
            model.NoiThat5 = cachedPictures.NoiThat5;
            model.PhuKien1 = cachedPictures.PhuKien1;
            model.PhuKien2 = cachedPictures.PhuKien2;
            model.PhuKien3 = cachedPictures.PhuKien3;
            model.PhuKien4 = cachedPictures.PhuKien4;
            model.PhuKien5 = cachedPictures.PhuKien5;
            #endregion
        ...
        public ActionResult ProductDetails(int productId, int updatecartitemid = 0)
        {
            ...
            model.Video = product.Video;
            model.NoiThat = product.NoiThat;
            model.NgoaiThat = product.NgoaiThat;
            model.TextNgoaithat1 = product.TextNgoaithat1;
            model.TextNgoaithat2 = product.TextNgoaithat2;
            model.TextNgoaithat3 = product.TextNgoaithat3;
            model.TextNgoaithat4 = product.TextNgoaithat4;
            model.TextNgoaithat5 = product.TextNgoaithat5;
            model.TextNoiThat1 = product.TextNoiThat1;
            model.TextNoiThat2 = product.TextNoiThat2;
            model.TextNoiThat3 = product.TextNoiThat3;
            model.TextNoiThat4 = product.TextNoiThat4;
            model.TextNoiThat5 = product.TextNoiThat5;
        ...
        public ActionResult RelatedProducts(int productId, int? productThumbPictureSize)
        {
            ...
            var news = _newsService.GetNewsByIds(productIds);
        ...
        public ActionResult Index(int? productThumbPictureSize)
        {
            var products = _productService.SearchProducts(
                  ...
                  showHidden: true
              ).Where(x => x.IsUocTinhVanChuyen == true);
            if (!products.Any())
                return Content("");

            var model = PrepareProductOverviewModels(products, true, true, productThumbPictureSize).ToList();
            var country = _countryService.GetCountryById(Convert.ToInt32(234));
            var states = _stateProvinceService.GetStateProvincesByCountryId(country != null ? country.Id : 0, _workContext.WorkingLanguage.Id).Where(x => x.IsEstimate == true).ToList();
            ViewData["district"] = states;
            ViewData["cars"] = model;
            return View();
        ...
        [HttpPost]
        public ActionResult Getversion(int productId, int? productThumbPictureSize)
        {

            var products = _productService.GetProductById(productId);

            var model = PrepareProductDetailsPageModel(products, null, true);

            if (model != null)
            {
                return PartialView("_Version", model.ProductAttributes);
            }
        ...
        [HttpPost]
        public ActionResult ESTIMATE(int productId, string versionproduct, int districtid, EstimateModel model)
        {
            var products = _productService.GetProductById(productId);
            var estimatecaculator = _EstimateService.GetEstimateByStateId(districtid);


            if (versionproduct == null)
            {
                double x = double.Parse(products.Price.ToString());
                model.Gia = x;
            }
            else
            {
                double y = double.Parse(versionproduct);
                model.Gia = y;

            }

            model.LePhiTruocBa = estimatecaculator.LePhiTruocBa;
            model.PhiBHVC = estimatecaculator.PhiBHVC;
            model.BaoHiemTNDS = estimatecaculator.BaoHiemTNDS;
            model.BienSo = estimatecaculator.BienSo;

            model.PhiDuongBo = estimatecaculator.PhiDuongBo;
            model.PhiKiemDinh = estimatecaculator.PhiKiemDinh;
            model.TongChiPhi = model.LePhiTruocBa * model.Gia / 100 + model.BienSo + model.PhiKiemDinh + model.Gia * model.PhiBHVC / 100 + model.PhiDuongBo + model.BaoHiemTNDS;
            model.TongCong = model.Gia + model.TongChiPhi;
            return PartialView("_Estimate", model);
        }
